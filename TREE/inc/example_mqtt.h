...
#define CLI_MQTT_SVR_NAME       "bs4kuft.mqtt.iot.gz.baidubce.com"
#define CLI_MQTT_SVR            "14.215.192.20"
#define MQTT_CALIST_BIN         "bdcalist.cer"
#define MQTT_CERT_BIN           "bd_cert.pam"
